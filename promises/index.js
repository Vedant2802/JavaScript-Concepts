...
//Key thing to learn here is that in the Js runtime via the fetch api , it resolves the promise internally you do not have to resolve it manually , you just have to use the .then to get the data , this is the mistake i was maling
